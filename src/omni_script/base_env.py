...
def vm_to_int(input: tuple[int, Any]) -> tuple[int, int]:
    ...
    if tag == TYPES[STRING]:
        ...
        raise RuntimeError(
            f'{tag}:{value} cannot be converted to an integer'
...
VMenv = [
    (TYPES[FUNC], {'type': 'builtin', 'func': vm_print, 'name': 'print'}),
    (TYPES[FUNC], {'type': 'builtin', 'func': vm_sleep, 'name': 'sleep'}),
    (TYPES[FUNC], {'type': 'builtin', 'func': vm_input, 'name': 'input'}),
    (TYPES[FUNC], {'type': 'builtin', 'func': vm_to_str, 'name': 'to_str'}),
    (TYPES[FUNC], {'type': 'builtin', 'func': vm_to_int, 'name': 'to_int'}),
    (TYPES[FUNC], {'type': 'builtin', 'func': vm_to_bool, 'name': 'to_bool'}),
]
...
ASTenv = [
    ...
    ('math', BuiltinModule([BuiltinFunction('hi', vm_hi)], 'math')),
]
